...
function createNewPlaylist(){
    ...
    newNode.innerHTML = '<h2><button class="playlist-btn" id=btn-'+ playlist_List[totalPlaylists].name +'" onclick="selectCustomlist(this.id)"><i class="fas fa-play"></i>' +  playlist_List[totalPlaylists].name + '</button></h2><ol id="'+playlist_List[totalPlaylists].name+'"></ol>'+' <button class="rmvbtn playlist-btn" id=rmv-'+ playlist_List[totalPlaylists].name +'" onclick="deleteLastSong(this.id)">Remove Last Song</button>' ;
